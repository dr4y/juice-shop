...
describe('/redirect', function () {
    ...
    describe('challenge "redirect"', function () {
        ...
        it('should redirect to target URL if https://github.com/OWASP/juice-shop is contained in it as parameter', function () {
            browser.driver.get(browser.baseUrl + '/redirect?to=https://www.owasp.org?trickIndexOf=https://github.com/OWASP/juice-shop').then(function() {
